...
export const Errors = {
    ...
    MAIL: {
        wrong_twitch_stream: {
            name: 'WRONG_TWITCH_STREAM',
            message: 'Wrong twitch stream',
            level: 1
        },
        incorrect_round_timings: {
            name: 'INCORRECT_ROUND_TIMINGS',
            message: 'Incorrect round timings',
            level: 1
        },
        wrong_multikills: {
            name: 'WRONG_MULTIKILLS',
            message: 'Multikills are wrong',
            level: 1
        },
        other: {
            name: 'OTHER',
